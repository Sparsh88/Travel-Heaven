...
// @desc    Seed database with demo destinations, packages & admin
// @route   POST /api/seed
// @access  Public (development only — guarded by env check)
router.post('/', async (req, res) => {
  ...
  try {
    ...
    const existingUser = await User.findOne({ email: 'user@travelheaven.com' });
    if (!existingUser) {
      await User.create({
        fullName: 'Demo User',
    ...
    const destinationsData = [
      {
        name: 'Bali',
        country: 'Indonesia',
        description: 'Discover the tropical paradise of Bali, famous for its forested volcanic mountains, iconic rice paddies, pristine beaches, and stunning coral reefs. A world-class destination for romance and nature lovers.',
      ...
      },
      {
        name: 'Manali',
        country: 'India',
        description: 'Manali is a high-altitude Himalayan resort town in the northern Himachal Pradesh state. A backpacker and adventure-lover\'s paradise with snow-capped peaks, river rapids, and lush valleys.',
        category: 'Domestic',
      ...
      },
      {
        name: 'Kerala',
        country: 'India',
        description: "Kerala, a state on India's tropical Malabar Coast, has nearly 600km of Arabian Sea shoreline. Known for its palm-lined beaches, serene backwaters, lush hill stations, and world-class Ayurvedic treatments.",
        category: 'Domestic',
        budgetCategory: 'Mid-Range',
        featured: false,
        rating: 4.7,
      ...
      },
      {
        name: 'Tokyo',
        country: 'Japan',
        description: "Tokyo, Japan's dynamic capital, seamlessly blends ultramodern and traditional — neon-lit skyscrapers alongside historic temples. A food, fashion, and technology lover's dream destination.",
        category: 'International',
        budgetCategory: 'Luxury',
        featured: false,
        rating: 4.8,
      ...
      },
      {
        name: 'Goa',
        country: 'India',
        description: "Goa is a state in western India with coastlines stretching along the Arabian Sea. Famed for its world-class beaches, Portuguese heritage architecture, vibrant nightlife, water sports, and fresh seafood.",
        category: 'Domestic',
        budgetCategory: 'Budget',
        featured: true,
        rating: 4.5,
    ...
    const destMap = {};
    seededDestinations.forEach((d) => { destMap[d.name] = d._id; });
    ...
    const packagesData = [
      {
        ...
        description: 'Experience Bali like never before. Stays in premium oceanfront private villa, couples massage, private catamaran cruise, and tours around iconic temples.',
        price: 63920,
        durationDays: 7,
        durationNights: 6,
        ...
        featured: true,
        itinerary: [
          { day: 1, title: 'Arrival & Welcome Dinner', description: 'Arrive at Ngurah Rai International Airport. Transfer to your oceanfront resort in Seminyak. Enjoy a romantic candlelit dinner at the beach.' },
          { day: 2, title: 'Uluwatu Temple & Kecak Dance', description: 'Visit the magnificent Uluwatu temple perched on a cliff edge. Watch the traditional Kecak Fire Dance performance against the sunset.' },
          ...
          { day: 4, title: 'Volcano Hiking & Hot Springs', description: 'Early morning hike up Mount Batur to witness the majestic sunrise. Relax in Toya Devasya natural hot springs.' },
          { day: 5, title: 'Nusa Penida Day Trip', description: 'Speedboat to Nusa Penida island. Visit Kelingking Beach, Angel\'s Billabong, and snorkel at Crystal Bay.' },
          { day: 6, title: 'Couples Spa & Sunset Cruise', description: 'Morning Ayurvedic couples massage. Afternoon luxury catamaran sunset dinner cruise.' },
          { day: 7, title: 'Departure', description: 'Free morning for shopping. Transfer to airport for your flight home.' },
        ],
      },
      {
        title: 'Luxury Paris Honeymoon & City Tour',
        destination: destMap['Paris'],
        description: 'Spend 5 glorious days in Paris. Includes Eiffel Tower skip-the-line, private Seine River dinner cruise, Louvre private guide, and Versailles palace day trip.',
        price: 119920,
        durationDays: 5,
        durationNights: 4,
        ...
        featured: true,
        itinerary: [
          { day: 1, title: 'Arrival & Hotel Check-in', description: 'Arrive in Paris. Transfer to boutique hotel near Champs-Élysées. Explore city of lights at your own pace.' },
          { day: 2, title: 'Eiffel Tower & Seine Cruise', description: 'Skip-the-line Eiffel Tower summit. Evening 3-course dinner cruise on the Seine River.' },
          { day: 3, title: 'Louvre & Notre Dame Walk', description: 'Private guided Louvre tour. Walk through Latin Quarter and view Notre-Dame Cathedral.' },
          { day: 4, title: 'Versailles Palace Trip', description: 'Train to magnificent Palace of Versailles. Explore Hall of Mirrors and royal gardens.' },
          { day: 5, title: 'Montmartre & Departure', description: 'Explore artistic Montmartre, visit Sacré-Cœur, pick up souvenirs before airport transfer.' },
        ],
      },
      {
        title: 'Thrill Seekers Manali Adventure',
        destination: destMap['Manali'],
        description: 'Action-packed adventure in the snow-capped mountains. Includes trekking, river rafting, paragliding, and camping under the stars.',
        price: 23920,
        durationDays: 4,
        durationNights: 3,
        ...
        featured: false,
        itinerary: [
          { day: 1, title: 'Camp Check-in & Acclimatization', description: 'Arrive in Manali. Transfer to riverside campsite in Solang Valley. Bonfire and live music.' },
          { day: 2, title: 'Paragliding & Zorbing Solang Valley', description: 'High-altitude paragliding, ATV rides, and adventure activities.' },
          { day: 3, title: 'White Water Rafting & Jogini Waterfalls', description: 'Beas River rafting, Jogini Waterfalls hike, Vashisht Hot Springs.' },
          { day: 4, title: 'Hadimba Temple & Departure', description: 'Explore historic Hadimba Temple, Mall Road shopping, then departure.' },
        ],
      },
      {
        title: 'Kerala Backwaters & Houseboat Experience',
        destination: destMap['Kerala'],
        description: "Immerse yourself in nature's greenery. Cruise serene backwaters on a private houseboat and relax with professional Ayurvedic spa therapies.",
        price: 39920,
        durationDays: 6,
        durationNights: 5,
        ...
        featured: false,
        itinerary: [
          { day: 1, title: 'Kochi Arrival & Transfer to Munnar', description: 'Arrive in Kochi, drive to Munnar through lush tea gardens and waterfalls.' },
          { day: 2, title: 'Munnar Tea Gardens Tour', description: 'Explore Eravikulam National Park, Mattupetty Dam, and tea estates.' },
          { day: 3, title: 'Thekkady Wildlife Reserve', description: 'Boat safari on Periyar Lake to spot elephants, deer, and exotic birds.' },
          { day: 4, title: 'Houseboat Boarding Alleppey', description: 'Board traditional houseboat. Glide along calm canals and watch the sunset.' },
          { day: 5, title: 'Ayurvedic Spa & Kochi Sightseeing', description: 'Authentic Ayurvedic massage. Fort Kochi sightseeing and Chinese Fishing Nets.' },
      ...
      },
      {
        ...
        featured: true,
        itinerary: [
          { day: 1, title: 'Goa Arrival & Calangute Beach Sunset', description: 'Arrive in Goa. Check in to beach resort. Relax at Calangute beach and enjoy beach shack nightlife.' },
          { day: 2, title: 'Scuba Diving & North Goa Water Sports', description: 'Boat trip for dolphin sighting and scuba diving. Jet ski, parasailing, and banana boat rides at Baga Beach.' },
          { day: 3, title: 'Old Goa Churches & Spice Plantation', description: 'Visit Basilica of Bom Jesus. Traditional lunch at a tropical Spice Plantation. Airport transfer.' },
        ],
      },
      {
    ...
    res.status(200).json({
      success: true,
      message: `✅ Database seeded successfully! Created ${seededDestinations.length} destinations and ${packagesData.length} packages.`,
